...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const error = document.getElementById("text-error-form");
  const campoPremios = {
  ...
  const mostrarError = (mensaje) => {
    ...
    inputCode.classList.add("border-banbif-text-error");
  };
  inputSubmit.addEventListener("click", function(e) {
    e.preventDefault();
    if (inputCode.value.trim() === "1") {
      mostrarError("El código no puede estar vacío");
      return;
    } else if (inputCode.value.trim() === "2") {
      mostrarError("El codigo ya ha sido utilizado");
      return;
    } else {
      error.classList.add("hidden");
      inputCode.classList.remove("border-banbif-text-error");
    }
    window.scrollTo({
      top: 0,
      behavior: "smooth"
      ...
      switch (premio) {
        case 1:
          ...
          setTimeout(() => {
            ...
            titlePremio.innerHTML = "1 iPhone 16 Pro Max <br> de 128 GB";
            descPremio.innerHTML = " Te enviaremos un correo detallando el premio.";
          }, 1e4);
          break;
        case 2:
        ...
        case 4:
          ...
          setTimeout(() => {
            ...
            descPremio.innerHTML = "Tienes 100 oportunidades más para ganar el Sorteo Genial. Te enviaremos un correo detallando el premio.";
          }, 1e4);
          break;
        case 5:
          ...
          setTimeout(() => {
            ...
            descPremio.innerHTML = "Tienes 500 oportunidades más para ganar el Sorteo Genial. Te enviaremos un correo detallando el premio.";
          }, 1e4);
          break;
        case 6:
          ...
          setTimeout(() => {
            ...
            descPremio.innerHTML = "Tienes 200 oportunidades más para ganar el Sorteo Genial. Te enviaremos un correo detallando el premio.";
          }, 1e4);
          break;
        case 7:
          ...
          setTimeout(() => {
            ...
            descPremio.innerHTML = "Tienes 1000 oportunidades más para ganar el Sorteo Genial. Te enviaremos un correo detallando el premio.";
          }, 1e4);
          break;
        case 8:
    ...
    setTimeout(() => {
      ...
      confettiCtx({
        ...
        // Velocidad inicial
        gravity: 0.4,
        // Gravedad para caída más lenta
        origin: {
          x: 0.5,
          // Centro horizontal
          y: 0.5
          // Centro vertical dentro del card
        },
        colors: ["#AD96DC", "#20A6FF", "#C4D600", "#E4A9BB"],
        // Colores personalizados
        scalar: 1.2
        // Tamaño de las partículas
      });
      setTimeout(() => confettiCtx.reset(), 5e3);
    }, 11e3);
  });
  function checkInput() {
    if (inputCode.value.trim() !== "") {
